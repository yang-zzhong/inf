...
func TestNode_del(t *testing.T) {
	...
	isNode("root", tree.root, []string{"04"}, t)
	isNode("level 1 left 1", tree.root.first, []string{"02"}, t)
	isNode("level 2 left 1", tree.root.first.first, []string{"01"}, t)
	isNode("level 2 left 2", tree.root.first.elems[0].(elem).after, []string{"03"}, t)
	isNode("level 1 left 2", tree.root.elems[0].(elem).after, []string{"06", "08"}, t)
	isNode("level 2 left 1", tree.root.elems[0].(elem).after.first, []string{"05"}, t)
	isNode("level 2 left 2", tree.root.elems[0].(elem).after.elems[0].(elem).after, []string{"07"}, t)
	isNode("level 2 left 3", tree.root.elems[0].(elem).after.elems[1].(elem).after, []string{"09", "10"}, t)
	tree.Del(SK("01"))
	isNode("root", tree.root, []string{"06"}, t)
	isNode("level 1 left 1", tree.root.first, []string{"04"}, t)
	isNode("level 2 left 1", tree.root.first.first, []string{"02", "03"}, t)
	isNode("level 2 left 2", tree.root.first.elems[0].(elem).after, []string{"05"}, t)
	isNode("level 1 left 2", tree.root.elems[0].(elem).after, []string{"08"}, t)
	isNode("level 2 left 1", tree.root.elems[0].(elem).after.first, []string{"07"}, t)
	isNode("level 2 left 2", tree.root.elems[0].(elem).after.elems[0].(elem).after, []string{"09", "10"}, t)
	tree.Del(SK("10"))
	isNode("root", tree.root, []string{"06"}, t)
	isNode("level 1 left 1", tree.root.first, []string{"04"}, t)
	isNode("level 2 left 1", tree.root.first.first, []string{"02", "03"}, t)
	...
	isNode("level 1 left 2", tree.root.elems[0].(elem).after, []string{"08"}, t)
	isNode("level 2 left 1", tree.root.elems[0].(elem).after.first, []string{"07"}, t)
	isNode("level 2 left 2", tree.root.elems[0].(elem).after.elems[0].(elem).after, []string{"09"}, t)
	tree.Del(SK("09"))
	isNode("root", tree.root, []string{"04", "06"}, t)
	isNode("level 1 left 1", tree.root.first, []string{"02", "03"}, t)
	isNode("level 1 left 1", tree.root.elems[0].(elem).after, []string{"05"}, t)
	isNode("level 1 left 2", tree.root.elems[1].(elem).after, []string{"07", "08"}, t)
	tree = createTree()
	tree.Del(SK("00"))
	tree.Del(SK("01"))
	tree.Del(SK("10"))
	...
	isNode("level 1 left 1", tree.root.first, []string{"02", "03"}, t)
	isNode("level 1 left 1", tree.root.elems[0].(elem).after, []string{"05"}, t)
	isNode("level 1 left 2", tree.root.elems[1].(elem).after, []string{"08", "09"}, t)
	tree.Put(SP("07", "07"))
	isNode("root", tree.root, []string{"06"}, t)
	isNode("level 1 left 1", tree.root.first, []string{"04"}, t)
	isNode("level 2 left 1", tree.root.first.first, []string{"02", "03"}, t)
	...
	tree.Del(SK("05"))
	isNode("root", tree.root, []string{"06"}, t)
	isNode("level 1 left 1", tree.root.first, []string{"03"}, t)
	isNode("level 2 left 1", tree.root.first.first, []string{"02"}, t)
	isNode("level 2 left 2", tree.root.first.elems[0].(elem).after, []string{"04"}, t)
	isNode("level 1 left 2", tree.root.elems[0].(elem).after, []string{"08"}, t)
	isNode("level 2 left 1", tree.root.elems[0].(elem).after.first, []string{"07"}, t)
	isNode("level 2 left 2", tree.root.elems[0].(elem).after.elems[0].(elem).after, []string{"09"}, t)
}
